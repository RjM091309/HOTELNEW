...
export let lastVehicleBatteryChangeTime = {}; // Track when battery level last changed
export let lastGpsBatteryChangeTime = {}; // Track when battery level last changed
